...
import { ChevronDown, ChevronUp, Calendar, User, Eye } from 'lucide-react';
...
// using shared Step interface from interfaces.ts
            ...
            <article className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <footer className="p-8 border-t border-gray-200 bg-gray-50">
                    <div className="text-center text-sm text-gray-500">
                        ...
                        {instruction.format_type && (
                            <p className="mt-2 capitalize">Format: {instruction.format_type}</p>
                        )}
                    </div>
                </footer>
            </article>
