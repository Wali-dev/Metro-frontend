...
//   // Initialize sensors ONCE (outside render to avoid recreation)
...
//     if (itemData) {
//       try {
//         const parsed = JSON.parse(decodeURIComponent(itemData)) as Instruction;
//         setInstruction(parsed);
//       } catch (error) {
//         console.error('Failed to parse instruction data from URL:', error);
//       } finally {
//         setIsLoading(false);
//       }
//     } else {
...
//           {...attributes}
//           {...listeners}
//           className="absolute right-3 top-3 cursor-grab active:cursor-grabbing p-1.5 rounded hover:bg-gray-100 transition-colors"
...
//       >
//         <SortableContext
//           items={instruction.steps?.map((_, index) => String(index)) || []}
